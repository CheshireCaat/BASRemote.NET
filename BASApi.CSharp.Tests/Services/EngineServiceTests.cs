...
namespace BASRemote.Tests.Services
{
    ...
    public class EngineServiceTests
    {
        ...
        [TestMethod]
        public async Task EngineInitialize_ShouldThrowException_WhenScriptNotFound()
        {
            await Assert.ThrowsExceptionAsync<ScriptNotFoundException>(() => _service.InitializeAsync());
        }
